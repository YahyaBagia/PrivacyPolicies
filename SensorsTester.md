...
Sensors Tester is an app that helps you test different sensors on your iOS device.

### Privacy Policy
I (Yahya Bagia) operates the Sensors Tester mobile application (hereinafter referred to as the "Service").
...
#### Definitions
- Service : Service is the Sensors Tester mobile application operated by Yahya Bagia
